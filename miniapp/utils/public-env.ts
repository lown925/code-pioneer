...
export const PUBLIC_API_ENVIRONMENT_CONFIG: PublicApiEnvironmentConfig = {
  developApiBaseUrl: "https://dfiovlydzsvq.sealoshzh.site/api/v1",
  trialApiBaseUrl: "https://dfiovlydzsvq.sealoshzh.site/api/v1",
  releaseApiBaseUrl: "https://dfiovlydzsvq.sealoshzh.site/api/v1",
};
