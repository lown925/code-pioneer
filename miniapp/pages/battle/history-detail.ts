  ...
  async loadDetail() {
    ...
    try {
      ...
      this.setData({
        ...
        skillText: response.professionalTrackKey || response.professionalTrack
          ? `${formatBattleTrack(response.myProfessionalTrackKey ?? response.professionalTrackKey, response.professionalTrack)}专业对战`
